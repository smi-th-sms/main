...
opcf /obj
set subnet = `run("opadd -n -v subnet E__script_pythonWorkSpace_kimodo_test_outputs_walk_test")`
opautoplace $subnet
opcf $subnet
...
opadd chopnet mocap
opcf mocap
opadd file E__script_pythonWorkSpace_kimodo_test_outputs_walk_test
opparm E__script_pythonWorkSpace_kimodo_test_outputs_walk_test file ( '$HIP/E:\script\pythonWorkSpace\kimodo_test_outputs\walk_test.bclip' ) rate (30) rateoption ( override ) export ( ../.. )
opadd null data
opparm data export ( ../.. )
opwire E__script_pythonWorkSpace_kimodo_test_outputs_walk_test -0 data
oplayout
opcf ..
