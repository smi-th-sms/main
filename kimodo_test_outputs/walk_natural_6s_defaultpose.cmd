...
opcf /obj
set subnet = `run("opadd -n -v subnet E__script_pythonWorkSpace_kimodo_test_outputs_walk_natural_6s_defaultpose")`
opautoplace $subnet
opcf $subnet
...
opadd chopnet mocap
opcf mocap
opadd file E__script_pythonWorkSpace_kimodo_test_outputs_walk_natural_6s_defaultpose
opparm E__script_pythonWorkSpace_kimodo_test_outputs_walk_natural_6s_defaultpose file ( '$HIP/E:\script\pythonWorkSpace\kimodo_test_outputs\walk_natural_6s_defaultpose.bclip' ) rate (30) rateoption ( override ) export ( ../.. )
opadd null data
opparm data export ( ../.. )
opwire E__script_pythonWorkSpace_kimodo_test_outputs_walk_natural_6s_defaultpose -0 data
oplayout
opcf ..
