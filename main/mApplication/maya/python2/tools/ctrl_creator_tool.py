...
사용:
    import importlib
    from python2.tools import ctrl_creator_tool
    importlib.reload(ctrl_creator_tool)
    ctrl_creator_tool.show()

Shelf / reload:
    from python2.tools import ctrl_creator_tool
    ctrl_creator_tool.reload_show()
"""

import os, math, json
import maya.cmds as cmds

MODULE_NAME = "python2.tools.ctrl_creator_tool"
...
def reload_show():
    ...
    if module is None:
        from python2.tools import ctrl_creator_tool as module
