...
Usage:
    from python3.rigging import tentacle_ribbon_rig_ui
    import importlib
...
from python3.rigging import tentacle_ribbon_rig as rig
...
def _reload_rig():
    ...
    try:
        ...
        sys.modules.pop('python3.rigging.tentacle_ribbon_rig', None)
        rig = importlib.import_module('python3.rigging.tentacle_ribbon_rig')
