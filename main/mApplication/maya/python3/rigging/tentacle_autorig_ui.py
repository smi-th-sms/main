...
from python3.rigging import tentacle_autorig as rig
...
def _reload_rig():
    ...
    try:
        ...
        sys.modules.pop('python3.rigging.tentacle_autorig', None)
        rig = importlib.import_module('python3.rigging.tentacle_autorig')
